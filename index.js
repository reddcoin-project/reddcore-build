 ...
 * <ul>
 * <li> `browser:uncompressed` - build uncomprssed browser bundle (`reddcore-*.js`)
 * <li> `browser:compressed` - build compressed browser bundle (`reddcore-*.min.js`)
...
function startGulp(name, opts) {
  ...
  var fullname = name ? 'reddcore-' + name : 'reddcore';
  var files = ['lib/**/*.js'];
  var tests = ['test/**/*.js'];
  var alljs = files.concat(tests);

  var buildPath = './node_modules/reddcore-build/';
  ...
  if (browser) {
    ...
    if (name !== 'lib') {
      browserifyCommand = browserifyPath + ' --require ./index.js:' + fullname + ' --external reddcore-lib -o ' + fullname + '.js';
    } else {
      browserifyCommand = browserifyPath + ' --require ./index.js:reddcore-lib -o reddcore-lib.js';
    }
